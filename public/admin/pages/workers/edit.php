...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $oldData = selectWhere($conn, 'workers', '*', "id = $id")[0];
}
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form id="quickForm" action="<?= getController("admin/workers/update.php") ?>" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    <input type="hidden" name="id" value="<?= $oldData['id'] ?>">

                                    <div class="form-group">
                                        <label for="id_number">Id Number</label>
                                        <input type="text" name="id_number" class="form-control" id="id_number" value="<?= $oldData['id_number'] ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="exp" class="form-control" id="exp" value="<?= $oldData['exp'] ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="birth_date" class="form-control" id="birth_date" value="<?= $oldData['birth_date'] ?>">
                                        <?php if (isset($_SESSION['errors']['exp'])) : ?>
