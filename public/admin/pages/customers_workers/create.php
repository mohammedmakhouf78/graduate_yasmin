        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Create Customer Jop</h3>
            </div>
            ...
            <div class="card-body">
              ...
              <form id="quickForm" action="<?= getController("admin/customers_workers/create.php") ?>" method="POST">
                <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group mb-0">
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" name="is_done" class="custom-control-input" id="is_done" value="1">
